  ...
  return (
    <section className="flex" name="Booking">
      <div className="w-1/2 h-[40rem] flex flex-col pl-16 gap-y-4">
        <span className="text-[27px] text-[#5E6282] font-sans font-semibold">Easy and Fast</span>
        <span className="capitalize text-[50px] text-[#14183E] w-[34rem] font-serif font-bold leading-snug mb-4">book your next trip in 3 easy steps</span>
        {bookingSteps.map((bookingStep) => (
          <div className="flex items-center gap-4 mb-8">
            <Image src={bookingStep.src} alt="" className="size-12" />
            <span className="w-[22rem]">
              <p className="font-bold font-sans text-[#5E6282] mb-1">{bookingStep.title}</p>
        ...
        <div className="w-[370px] h-[400px] bg-white text-[#84829A] shadow-2xl shadow-gray-200 rounded-3xl flex justify-center items-center z-10">
          <div className="flex justify-center flex-col gap-[1.475rem] text-[16px]">
            ...
            <div className="flex gap-4">
              {bottuns.map((button) => (
                <span className="size-9 bg-[#F5F5F5] rounded-full flex justify-center items-center">
